        ...
        <div className="pointer-events-auto relative w-[96vw] max-w-[640px] overflow-hidden rounded-3xl border border-slate-800 bg-slate-950/85 shadow-2xl backdrop-blur">
          ...
          <div className="relative p-5">
            <img
              src="/chain-icon.jpg"
              alt="Chain"
              className="pointer-events-none absolute right-5 top-5 h-24 w-24 rounded-full border-2 border-orange-400/80 object-cover shadow-[0_0_30px_rgba(251,146,60,0.45)] ring-4 ring-orange-300/20"
            />
            <ChatWidget
              withContainer={false}
              title="Chat"
