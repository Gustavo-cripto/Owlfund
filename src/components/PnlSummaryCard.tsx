...
export default function PnlSummaryCard({
  ...
  return (
    <div
      className={`pnl-card animate-reveal rounded-3xl border border-orange-500/20 bg-gradient-to-br from-orange-500/20 via-slate-900 to-slate-950 p-6 ${className}`}
    >
