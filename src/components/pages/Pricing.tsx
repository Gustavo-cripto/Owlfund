            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className={`rounded-2xl border p-6 space-y-5 relative overflow-hidden ${currentPlan === "pro" ? "border-orange-400 bg-orange-500/10" : "border-orange-500/40 bg-orange-500/5"}`}>
                ...
                {loading ? (
                  ...
                  <Link href={pageUrl("beta", lang)} className="block rounded-xl border border-orange-500/40 bg-orange-500/10 px-4 py-2.5 text-center transition hover:border-orange-400/60">
              ...
              <div className={`rounded-2xl border p-6 space-y-5 relative overflow-hidden ${currentPlan === "premium" ? "border-violet-400 bg-violet-500/10" : "border-violet-500/40 bg-violet-500/5"}`}>
                ...
                {loading ? (
                  ...
                  <Link href={pageUrl("beta", lang)} className="block rounded-xl border border-violet-500/40 bg-violet-500/10 px-4 py-2.5 text-center transition hover:border-violet-400/60">
