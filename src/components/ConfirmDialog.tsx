...
export function useConfirm(): ConfirmFn {
  ...
  // aberta. Foi o que aconteceu durante meses, porque o provider vivia dentro
  // do AppShell e as páginas chamam este hook acima dele. Agora está no
  // RootShell; se algum dia voltar a faltar, grita em vez de se degradar em
  // silêncio — foi o silêncio que deixou isto passar.
