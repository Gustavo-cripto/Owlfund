          ...
          <div className="space-y-1.5 border-t border-slate-800 pt-3">
            ...
            <ul className="space-y-1">
              {[
                ...
                ["POST", "/api/v1/chat", "pergunta à IA ({ message }) · máx. 50/dia"],
            ...
            <a href="/developers" className="inline-block pt-1 text-[10px] font-semibold text-orange-300/90 hover:text-orange-200">{t("dev_full_docs")} →</a>
          </div>
        </div>
      ) : (
