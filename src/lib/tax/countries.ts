...
export type Allowance = {
  ...
  /** Rótulo por idioma — aparece nos guias públicos PT e EN e na calculadora. */
...
export const COUNTRIES: readonly Country[] = [
  ...
  { code: "DE", slug: { pt: "alemanha", en: "germany" }, flag: "🇩🇪", plan: "free",    law: "EStG § 23",                                        regime: { short: 0.45,  long: 0.0,   longDays: 365, longLabel: "Isento (>1 ano)", allowance: { amount: 1000, kind: "threshold", label: { pt: "Freigrenze €1.000/ano", en: "Freigrenze €1,000/year" } } } },
  { code: "GB", slug: { pt: "reino-unido", en: "united-kingdom" }, flag: "🇬🇧", plan: "pro",     law: "TCGA 1992 / HMRC (Autumn Budget 2024)",            regime: { short: 0.24,  long: 0.24,  longDays: 0,   longLabel: "18%/24% (sem distinção temporal)", allowance: { amount: 3500, kind: "deduct", label: { pt: "Isenção anual £3.000 (≈€3.500)", en: "Annual exemption £3,000 (≈€3,500)" } } } },
  ...
  { code: "BE", slug: { pt: "belgica", en: "belgium" }, flag: "🇧🇪", plan: "pro",     law: "CIR92 art. 90 / regime mais-valias 2026",          regime: { short: 0.10,  long: 0.10,  longDays: 0,   longLabel: "10% (gestão privada; especulativo 33%)", allowance: { amount: 10000, kind: "deduct", label: { pt: "Isenção anual €10.000 (regime 2026)", en: "Annual exemption €10,000 (2026 regime)" } } } },
  { code: "IE", slug: { pt: "irlanda", en: "ireland" }, flag: "🇮🇪", plan: "pro",     law: "TCA 1997 / Revenue CGT",                           regime: { short: 0.33,  long: 0.33,  longDays: 0,   longLabel: "33% (CGT, sem distinção temporal)", allowance: { amount: 1270, kind: "deduct", label: { pt: "Isenção anual €1.270", en: "Annual exemption €1,270" } } } },
  ...
  { code: "LU", slug: { pt: "luxemburgo", en: "luxembourg" }, flag: "🇱🇺", plan: "pro",     law: "LIR art. 99bis",                                   regime: { short: 0.42,  long: 0.0,   longDays: 183, longLabel: "Isento (>6 meses)", allowance: { amount: 500, kind: "threshold", label: { pt: "Isento se ganhos especulativos < €500/ano", en: "Exempt if speculative gains < €500/year" } } } },
  ...
  { code: "MX", slug: { pt: "mexico", en: "mexico" }, flag: "🇲🇽", plan: "premium", law: "LISR (ISR) / SAT",                                 regime: { short: 0.35,  long: 0.35,  longDays: 0,   longLabel: "1,92–35% (ISR progressivo)", allowance: { amount: 3000, kind: "deduct", label: { pt: "Isenção anual MX$60.000 (≈€3.000)", en: "Annual exemption MX$60,000 (≈€3,000)" } } } },
